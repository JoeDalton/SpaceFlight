...
class Integrator:
    ...
    def set_state_variables(self, partial_x: np.ndarray, partial_x_dot: np.ndarray, partial_x_dot_previous: np.ndarray):
        """
    ...
    def step(self, task):
        ...
        derivative with the current derivative to get an ABA initialization
        of that variable.
        """
