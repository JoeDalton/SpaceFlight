...
from space_flight.ai import HALF_PI, REFERENCE_ERROR_VELOCITY_MPS, Personality
from space_flight.ai.generic.generic_pilot import GenericPilot
from space_flight.utils import safe_angle_rad


class CapitalShipPilot(GenericPilot):
    """
    A class to hold the autopilot of capital ships

    TODO : it's exactly the same as the fighter's. Remove duplicated code
    """
